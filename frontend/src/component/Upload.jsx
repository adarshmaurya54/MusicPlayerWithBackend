            ...
            <div className="mb-4">
              <div className="md:flex">
                <div className="w-full">
                  <div className="relative  transition-all duration-500 group border-[3px] border-dashed border-gray-300 rounded-3xl p-6 hover:shadow-lg hover:border-black dark:hover:border-white">
                    <div className="flex flex-col items-center justify-center h-48 space-y-3 text-center">
                      ...
                      <span className="block text-gray-600 dark:text-white transition-all duration-500 font-semibold text-lg group-hover:text-black dark:group-hover:text-white">
