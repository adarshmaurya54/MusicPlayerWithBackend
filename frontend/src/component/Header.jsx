...
const Header = ({ handleToggleUpload }) => {
  ...
  return (
    <header className="z-30 md:px-10 px-4 py-5">
      <div className="dark:border-gray-700 border p-5 rounded-3xl bg-white dark:bg-slate-900 backdrop-blur-lg flex md:flex-row flex-col justify-between md:items-center gap-4">
