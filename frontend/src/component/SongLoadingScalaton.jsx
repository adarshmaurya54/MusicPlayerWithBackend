    ...
    <>
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-5">
        {skeletons.map((_, index) => (
          <div
            key={index}
            className="relative group flex flex-col space-y-2 bg-white dark:bg-slate-500 dark:border-none border border-gray-200 shadow-lg rounded-xl p-4 animate-pulse"
          >
      ...
      <div className="flex py-3 md:bg-transparent dark:bg-slate-500 dark:md:bg-transparent bg-white rounded-xl md:justify-center justify-evenly mt-4 items-center animate-pulse">
