...
const Users = () => {
    ...
    return (
        <div className="fixed bg-black/50 inset-0 z-50 flex justify-center items-center backdrop-blur-sm">
            <div className="bg-white bg-opacity-95 backdrop-blur-sm p-6 overflow shadow-2xl md:rounded-3xl md:w-[90%] md:h-[90%] h-full w-full ">
                ...
                {/* User Cards */}
                <div className="grid grid-cols-1 no-scrollbar overflow-auto h-[90%] sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {users?.map((user, index) => (
                        <div key={index} className="bg-white rounded-2xl p-4 flex flex-col items-center text-center">
                            <img
