...
function PlaylistCard({playlist}) {
    return (
            <div
                className="w-full bg-center bg-no-repeat group overflow-hidden h-[220px] relative rounded-3xl transition-all duration-500"
                style={{backgroundImage: `url(${import.meta.env.VITE_BASEURL + "/assets/thumbnails/default-thumbnail-low.png"})`}}
            >
